...
export const Modal = ({
  ...
  return (
    <>
      <button
        className={`text-white bg-[#a8ad9a] hover:bg-transparent hover:text-green-900 text-xl border-2 border-[#a8ad9a] cursor-pointer py-4 px-6 mt-5`}
        data-aos='fade-up'
      ...
      {isOpen && (
        <div className={`fixed inset-0 ${claseModal} backdrop-blur-md flex justify-center items-center z-50`} style={styleModal}>
